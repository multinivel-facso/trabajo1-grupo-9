...
plot(plt) +
  labs(
    ...
    y = "Índice de Adhesión a Principios Democráticos Liberales"
  )
...
2)  P01 de -0,84: A mayor percepción promedio de valores democráticos, menor incidencia de variables exógenas.

3)  LLama la atención que el coeficiente de prom_imp_dem  es mayor que su forma individual imp_dem, lo que indicaría que la percepción del contexto es más influyente que la individual.
